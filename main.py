...
for contacts in driver.find_elements_by_class_name('_21xgG'):    
    title = contacts.find_element_by_xpath('div/div/div[2]/div[1]/div[1]/span').text
    #company = person.find_element_by_xpath('.//div[@class="company"]/a').text
    contact_list+=list(title.split('\n'))   
print(contact_list)
#response Dictionaries
#add this according to you 
response = {
...
for name in contact_list:
    ...
    msg_got =driver.find_elements_by_css_selector(".GDTQm.message-in.focusable-list-item")
